...
**DiGi.GIS.Rhino** is a C# engineering and architectural software library suite designed for BIM and CAD integrations (such as Revit, RhinoCommon, Grasshopper, and Dynamo BIM).
...
* **[DiGi.GIS.Analytical.Rhino](DiGi.GIS.Analytical.Rhino)** (Path: `DiGi.GIS.Rhino\DiGi.GIS.Analytical.Rhino`)
* **[DiGi.GIS.Rhino](DiGi.GIS.Rhino)** (Path: `DiGi.GIS.Rhino\DiGi.GIS.Rhino`)
